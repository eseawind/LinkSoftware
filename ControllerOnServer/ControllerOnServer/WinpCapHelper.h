...
private:
	...
	int devID;//网卡号
	HWND m_hWnd[10][HWND_Number];//已注册的窗口句柄
public:
	...
	void setMyHWnd(HWND hWnd,int i,int j);//注册窗口句柄
	...
	void sendConfigFile(unsigned long long dstAddrHex,const CString& filePath);//开始发送配置文件
